...
namespace TiendaServicios.Api.Libro.Tests
{
    ...
    public class LibrosServiceTest
    {
        ...
        public async void GetLibroPorId()
        {
            ...
            var mapCondig = new MapperConfiguration(cfg =>
            {
                cfg.AddProfile(new MappingTest());
            });

            var mapper = mapCondig.CreateMapper();
        ...
        public async void GetLibros()
        {
            ...
            //que metodo dentro de mi micro libro se essta encargando 
            //de realizar la conulta de libros de la base de datos
